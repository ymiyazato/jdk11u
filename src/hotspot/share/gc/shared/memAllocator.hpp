...
private:
  ...
  HeapWord* allocate_outside_tlab(Allocation& allocation, bool isHugepage = false) const;
...
protected:
  ...
  // mem_allocate.
  virtual HeapWord* mem_allocate(Allocation& allocation, bool isHugepage = false) const;
...
public:
  oop allocate(bool isHugepage = false) const;
